...
<br><br>
            ...
            <div class="card">
                ...
                <div class="text-center mt-2">
                    <img id="image_id" style="width: 150px " class="card-img-top" src="{{ asset('images/profile_photo'.'/'.Auth::user()->profile_photo) }}" alt="Card image cap">
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('profile.profilephoto') }}" enctype="multipart/form-data" method="post" class="form">
                        ...
                        <div class="form-group">
                            <label>Photo</label>
                            <input  onchange="document.getElementById('image_id').src = window.URL.createObjectURL(this.files[0])" type="file" name="profile_photo" class="form-control" accept=".jpg,.png,.jpeg" >
                            <span class="text-danger">
                               @error('profile_photo')
                                {{ $message }}
                               @enderror
