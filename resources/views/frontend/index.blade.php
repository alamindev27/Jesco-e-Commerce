                        ...
                        <div class="tab-content mb-30px0px">
                            ...
                            @foreach ($categorys as $category)
                                ...
                                <div class="tab-pane fade" id="tab-product--{{ $category->category_name }}">
                                    <div class="row">
                                    @foreach (App\Models\Product::where('category_name', $category->id)->get() as $product)
                                        @include('parts.product_thumb')
                                    @endforeach
                                    </div>
                                </div>
                ...
                @foreach ($categorys as $category)
                    <div class="col-12 col-lg-4 mt-4">
                        <div class="single-banner-2">
                            <img src="{{ asset('images/category_photo').'/'.$category->category_image }}" alt="">
                            <div class="item-disc">
                                <h4 class="title">Best Collection <br>
                                    For {{ $category->category_name }}</h4>
                                <a href="{{ route('categorywayesproduct',$category->id) }}" class="shop-link btn btn-primary">Shop Now <i
