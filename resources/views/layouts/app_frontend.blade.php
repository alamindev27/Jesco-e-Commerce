            ...
            <div class="container position-relative">
                <div class="row">
                    ...
                    <div class="col col-lg-auto align-self-center pl-0">
                        <div class="header-actions" style="cursor: pointer">
                            @auth
                                <span>{{ auth()->user()->name }}</span>
                            @else
                                <a data-bs-toggle="modal" data-bs-target="#loginActive" class="header-action-btn login-btn" data-bs-toggle="modal"
                            ...
                            <a href="#offcanvas-cart"
                                ...
                                <span class="header-action-num">{{ allcartcount() }}</span>
        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    ...
                    <li>
                        <a href="" class="image">
                            <img src="{{ asset('images/product_image/')}}/{{ App\Models\Product::find($wishlist->product_id)->product_iamge }}"
                                alt="Cart product Image">
                            </a>
                        <div class="content">
                            <a href="{{ url('product/details')}}/{{ App\Models\Product::find($wishlist->product_id)->slug }}" class="title">{{ App\Models\Product::find($wishlist->product_id)->product_name  }}</a>
        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                ...
                @forelse (allcart() as $cart)
                    <li>
                        <a href="single-product.html" class="image"><img src="{{ asset('images/product_image') }}/{{ $cart->relationtoproduct->product_iamge }}"
                                alt="Cart product Image"></a>
                        <div class="content">
                            <a href="{{ route('productdetails', $cart->relationtoproduct->slug) }}" class="title">{{ $cart->relationtoproduct->product_name }}</a>
                            <span class="quantity-price">{{ $cart->amount }} x <span class="amount">${{ $cart->relationtoproduct->product_price }}</span></span>
                            <small>{{ $cart->amount*$cart->relationtoproduct->product_price }}</small>
                            <a href="#" class="remove">×</a>
                        </div>
                    </li>
                @empty
                    Nothing to add carts
                @endforelse
