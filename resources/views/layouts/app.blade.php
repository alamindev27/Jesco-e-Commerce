        ...
        <div id="wrapper">
            ...
            <div class="left side-menu">
                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    ...
                    <div class="user-box">
                        <div class="user-img">
                            <img src="{{ asset('images/profile_photo').'/'.Auth::user()->profile_photo }}" alt="user-img" title="Mat Helme" class="rounded-circle img-fluid">
                        </div>
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            @if (auth()->user()->role == 2)
                            <li>
                                <a href="{{ route('location') }}"><i class="fi-layers"></i> <span> Location </span></span></a>
                            </li>
                            <li>
                            ...
                            {{-- <li>
                                <a href="{{ route('email.offers') }}">
                                    <i class="fi-air-play"></i> <span> Offers </span>
                                </a>
                            </li> --}}
                        ...
                        <ul class="list-unstyled topbar-right-menu float-right mb-0">
                            ...
                            <li class="dropdown notification-list">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-lg">
                                    ...
                                    <div class="slimscroll" style="max-height: 230px;">
                                        ...
                                        <!-- item-->
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon"><img src="{{ asset('backend') }}/assets/images/users/avatar-3.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                                        ...
                                        <!-- item-->
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon"><img src="{{ asset('backend') }}/assets/images/users/avatar-4.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                                        ...
                                        <!-- item-->
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon"><img src="{{ asset('backend') }}/assets/images/users/avatar-5.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                                        ...
                                        <!-- item-->
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon"><img src="{{ asset('backend') }}/assets/images/users/avatar-6.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                            ...
                            <li class="dropdown notification-list">
                                <a class="nav-link dropdown-toggle nav-user" data-toggle="dropdown" href="#" role="button"
                                   aria-haspopup="false" aria-expanded="false">
                                    <img src="{{ asset('images/profile_photo').'/'.Auth::user()->profile_photo }}" alt="user" class="rounded-circle"> <span class="ml-1">{{ Auth::user()->name}} <i class="mdi mdi-chevron-down"></i> </span>
                                </a>
